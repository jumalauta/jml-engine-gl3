...
Scene.prototype.addAnimation = function(animationDefinitions)
{
    ...
    for (var animationI = 0; animationI < animationDefinitions.length; animationI++)
    {
        ...
        {
            this.loader.addNotifyResource(animationDefinition.object);
        }
        else if (animationDefinition.image !== void null)
        {
            if (this.loader.addNotifyResource(animationDefinition.image))
            {
        ...
        if (animationLayers.hasOwnProperty(key))
        {
            ...
            for (var animationI = 0; animationI < animationLayersLength; animationI++)
            {
                ...
                else if (animationDefinition.image !== void null)
                {
                    ...
                    animationDefinition.ref = new Image();
                    ...
                    if (animationDefinition.image[0].video !== void null)
                    {
                        ...
                        video.ref = new Video();
                        video.ref.load(animationDefinition.image[0].name);
                    ...
                    {
                        var multiTexRef = new Image();
                        multiTexRef.load(animationDefinition.image[imageI].name);
                        ...
                        if (animationDefinition.image[imageI].video !== void null)
                        {
                            ...
                            video.ref = new Video();
                            video.ref.load(animationDefinition.image[imageI].name);
                ...
                else if (animationDefinition.fbo !== void null)
                {
                    ...
                    animationDefinition.ref = new Fbo();
                    animationDefinition.ref.init(animationDefinition.fbo.name);
